...
public String toString() {
	return "ExhibitionDto [exno=" + exno + ", teenPrice=" + teenPrice + ", normalPrice=" + normalPrice + ", startDate="
			+ startDate + ", address=" + address + ", place=" + place + ", endDate=" + endDate + ", fno=" + fno
			+ ", name=" + name + ", folder=" + folder + ", saveName=" + saveName + "]";
}
