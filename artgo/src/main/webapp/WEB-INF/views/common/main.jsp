...
<c:set var="root" value="${pageContext.request.contextPath}" />
				...
				<div class="row h-100 align-items-center">
					...
					<div class="col-12 col-sm-4">
						<div class="top-social-area">
							<a href="${root}/member/loginPage.do" class="login" data-toggle="tooltip" data-placement="bottom"
								title="login"><span>로그인</span></a> 
							<a href="${root}/member/joinPage.do" data-toggle="tooltip" data-placement="bottom" title="join"><span>회원가입</span></a>
											...
											<div id="imaginary_container">
												<div class="input-group stylish-input-group">
													<input type="text" class="form-control"
														...
														class="input-group-addon" id="search">
														<button type="submit">
	...
	<div class="hero-area">
		...
		<div class="hero-slides owl-carousel">
			...
			<div id="myDiv" class="single-hero-slide bg-img"
				style="background-image: url(${root}/img/bg-img/b2.jpg); height: 350px;">
			...
			<!-- Single Slide -->
			<div id="myDiv" class="single-hero-slide bg-img"
				style="background-image: url(${root}/img/bg-img/b1.jpg); height: 350px;">
			...
			<div class="row align-items-end">
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-catagory-area clearfix mb-100">
						<img src="${root}/img/blog-img/1.jpg" alt="">
						<!-- Catagory Title -->
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-catagory-area clearfix mb-100">
						<img src="${root}/img/blog-img/2.jpg" alt="">
						<!-- Catagory Title -->
						<div class="catagory-title">
				...
				<div class="col-12 col-lg-9">
						...
						<div class="row align-items-center">
							<div class="col-12 col-md-6">
								<div class="single-blog-thumbnail">
									<img src="${root}/img/blog-img/3.jpg" alt="">
									<div class="post-date">
					...
					<div class="single-blog-area blog-style-2 mb-50 wow fadeInUp"
						...
						<div class="row align-items-center">
							<div class="col-12 col-md-6">
								<div class="single-blog-thumbnail">
									<img src="${root}/img/blog-img/4.jpg" alt="">
									<div class="post-date">
										<a href="#">12 <span>march</span></a>
									</div>
								</div>
					...
					<div class="single-blog-area blog-style-2 mb-50 wow fadeInUp"
						...
						<div class="row">
							<div class="col-12">
								<div class="single-blog-thumbnail">
									<img src="${root}/img/blog-img/7.jpg" alt="">
									<div class="post-date">
					...
					<div class="single-blog-area blog-style-2 mb-50 wow fadeInUp"
						...
						<div class="row align-items-center">
							<div class="col-12 col-md-6">
								<div class="single-blog-thumbnail">
									<img src="${root}/img/blog-img/5.jpg" alt="">
									<div class="post-date">
										<a href="#">12 <span>march</span></a>
									</div>
								</div>
					...
					<div class="single-blog-area blog-style-2 mb-50 wow fadeInUp"
						...
						<div class="row align-items-center">
							<div class="col-12 col-md-6">
								<div class="single-blog-thumbnail">
									<img src="${root}/img/blog-img/6.jpg" alt="">
									<div class="post-date">
										<a href="#">12 <span>march</span></a>
									</div>
								</div>
				...
				<div class="col-12 col-md-4 col-lg-3">
					<div class="post-sidebar-area">
						...
						<div class="sidebar-widget-area">
							...
							<a href="#"><img src="${root}/img/bg-img/add.gif" alt=""></a>
						</div>
							...
							<div class="widget-content">
								...
								<div
									...
									<div class="post-thumbnail">
										<img src="${root}/img/blog-img/lp1.jpg" alt="">
									</div>
									<!-- Post Content -->
								...
								<div
									...
									<!-- Post Thumbnail -->
									<div class="post-thumbnail">
										<img src="${root}/img/blog-img/lp2.jpg" alt="">
									</div>
									<!-- Post Content -->
									<div class="post-content">
										<a href="#" class="post-tag">Lifestyle</a>
								...
								<div
									...
									<!-- Post Thumbnail -->
									<div class="post-thumbnail">
										<img src="${root}/img/blog-img/lp3.jpg" alt="">
									</div>
									<!-- Post Content -->
									<div class="post-content">
										<a href="#" class="post-tag">Lifestyle</a>
								...
								<div
									...
									<!-- Post Thumbnail -->
									<div class="post-thumbnail">
										<img src="${root}/img/blog-img/lp4.jpg" alt="">
									</div>
									<!-- Post Content -->
									<div class="post-content">
										<a href="#" class="post-tag">Lifestyle</a>
	...
	<div class="instagram-feed-area">
		...
		<div class="instagram-slides owl-carousel">
			...
			<!-- Single Insta Feed -->
			<div class="single-insta-feed">
				<img src="${root}/img/instagram-img/2.png" alt="">
				<!-- Hover Effects -->
				<div class="hover-effects">
					<a href="#"
						class="d-flex align-items-center justify-content-center"><i
			...
			<!-- Single Insta Feed -->
			<div class="single-insta-feed">
				<img src="${root}/img/instagram-img/3.png" alt="">
				<!-- Hover Effects -->
				<div class="hover-effects">
					<a href="#"
						class="d-flex align-items-center justify-content-center"><i
			...
			<!-- Single Insta Feed -->
			<div class="single-insta-feed">
				<img src="${root}/img/instagram-img/4.png" alt="">
				<!-- Hover Effects -->
				<div class="hover-effects">
					<a href="#"
						class="d-flex align-items-center justify-content-center"><i
			...
			<!-- Single Insta Feed -->
			<div class="single-insta-feed">
				<img src="${root}/img/instagram-img/5.png" alt="">
				<!-- Hover Effects -->
				<div class="hover-effects">
					<a href="#"
						class="d-flex align-items-center justify-content-center"><i
			...
			<!-- Single Insta Feed -->
			<div class="single-insta-feed">
				<img src="${root}/img/instagram-img/6.png" alt="">
				<!-- Hover Effects -->
				<div class="hover-effects">
					<a href="#"
						class="d-flex align-items-center justify-content-center"><i
			...
			<!-- Single Insta Feed -->
			<div class="single-insta-feed">
				<img src="${root}/img/instagram-img/7.png" alt="">
				<!-- Hover Effects -->
				<div class="hover-effects">
					<a href="#"
						class="d-flex align-items-center justify-content-center"><i
	...
	<!-- ##### Instagram Feed Area End ##### -->
		...
		<script src="${root}/js/jquery/jquery-2.2.4.min.js"></script>
		<!-- Popper js -->
		...
		<!-- Active js -->
		<script src="${root}/js/active.js"></script>
